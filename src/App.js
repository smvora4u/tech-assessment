...
import StringTest from "./util/string-test";
...
function App() {
  ...
  const testStringClickHandler = () => {
    ...
    if (StringTest.hasMatchedCurlyBrackets({str: testString})) {
  ...
  return (
    <>
      <div>
        <label htmlFor="validCurlyBrackets">
      ...
      <input
        ...
        data-testid="validCurlyBrackets"
        value={testString}
